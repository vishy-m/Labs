public abstract class Sprite
{
    ...
    public boolean getStatus(){return shouldRemove;}
    ...
    public boolean collides(double ox, double oy, double owidth, double oheight)
    {
        double left = x - width / 2;
        double right = x + width / 2;
        double top = y + height / 2;
        ...
        double oleft = ox - owidth / 2;
        double oright = ox + owidth / 2;
        double otop = oy + oheight / 2;
        double obottom = oy - oheight / 2;
