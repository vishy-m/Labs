/**
 * TestGUI by Kris McCoy & Dagar Ahmed   v2.2
 * Run customized tests of various classes/method and custom build your GUI

 * This version adds:
 * Support for varArg constructors.
 * Improved overloading of makeObject, testMethod, and runAsThread
 ...
 * TO TEST A CONSTRUCTOR AND RECEIVE THE INSTANCE:
 ...
 *     Object makeObject(String className, Class varArgType, Object[] args, String inputScript)
 *
 *     Parameters:
 ...
 *         requests user input
 *     varArgType - class object representing the data type of a varArgs constructor (Note: This is used for
 *         casting, not for determining appropriate constructor.  Current version assumes that there would
 *         only be one varArgs constructor in student code and immediate attaches to first encountered.)
 *      
 *     Returns:
 ...
 *     Object testMethod(Object o,     String mName)
 *     Object testMethod(String cName, String mName)
 ...
 *     args - arguments being passing to the method, or null
 ...
 *     boolean runAsThread(Object o, String mName)
...
public class TestGUI 
{
   ...
   public static final double V_NUM = 2.2;
   ...
   public void compileAllSrcFiles() {
      ...
      if (baos.size() > 0) {
         baos.reset();
         System.out.println("Trying to compile all project files at once caused errors/warnings.");
   ...
   static class TestData {
      ...
      public static Object makeObject(String cName, Class<?> varArgsType, Object[] args, String userInputScript) {
         ...
         try {            
            ...
            //Let's try to find a constructor that matches our argument list
            outerLoop:
            for (Class[] argCombo : argOptions) {
               for (Constructor conOption : availableConstructors) {
                  //See if this conOption is a good fit
                  
                  //see if our args meet the varArgs requirement
                  if (varArgsType != null && conOption.isVarArgs()) {                        
                     //Currently, I'm assuming that if we have a varArgsType that
                     //the first varArgs constructor we find will be the correct one.
                     //This can be assumed later.
                     conSearch = conOption;   
                     break outerLoop;        
                  }                  
                  
                  //If not varArgs, its parameters must match with this argCombo                                                
            ...
            if (con.isVarArgs()) {
               Object[] varArgsArray = (Object[]) java.lang.reflect.Array.newInstance(varArgsType, args.length);
               for (int i = 0; i < args.length; i++)
                  varArgsArray[i] = varArgsType.cast(args[i]);
               argList = new Object[] { varArgsArray };                                 
            } else { 
               argList = args;
            }
      ...
      public static boolean runAsThread(Object o, String name) {
         return runAsThread(o, name, null);
      }
      ...
      public static Object makeObject(String cName, Object[] args, String userInputScript) {
         return makeObject(cName, null, args, userInputScript); 
      }
   
      public static Object makeObject(String cName, Class<?> varArgType, Object[] args) {
         return makeObject(cName, varArgType, args, null); 
      }
   
      public static Object makeObject(String cName, Object[] args) {
         return makeObject(cName, null, args, null);  
      }
      
      public static Object makeObject(String cName) {
         return makeObject(cName, null, null, null);  
      }
      ...
      public static Object testMethod(Object o, String name) {
         return testMethod(o, name, null, null, 0.0, null);
      }
   
      public static Object testMethod(String cName, String name) {              
         return testMethod(cName, name, null, null, 0.0, null);
      }
