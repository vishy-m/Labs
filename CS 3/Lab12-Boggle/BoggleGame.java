...
public class BoggleGame extends JFrame {
   ...
   public BoggleGame(int rows, int cols) {
      ...
      foundWordsList.setCellRenderer(
      ...
      validWordsList.setCellRenderer(
         new DefaultListCellRenderer() {
            @Override
            public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
               Component comp = super.getListCellRendererComponent(list, value, index, false, false);
      ...
      opponentFoundWordsList.setCellRenderer(
         new DefaultListCellRenderer() {
            @Override
            public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
               Component comp = super.getListCellRendererComponent(list, value, index, false, false);
      ...
      Scanner in = null;
      try { in = new Scanner(new File(PATH + "dictionary-shakespeare.txt")); } 
      ...
      // all words in shakespeare
      try { in = new Scanner(new File(PATH + "dictionary-nursery.txt")); } 
      catch (FileNotFoundException f) {}
      ...
      try { in = new Scanner(new File(PATH + "dictionary-common.txt")); } 
      catch (FileNotFoundException f) {}
      ...
      try { in = new Scanner(new File(PATH + "dictionary-algs4.txt")); } 
      catch (FileNotFoundException f) {}
   ...
   private void makeMenuBar() {
      ...
      endGameMenuItem.addActionListener(
         new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
               endGame();
      ...
      for (int i = 0; i < NUMBER_OF_LEVELS; i++) {
         ...
         difficultySelection[i].addActionListener(
            new ActionListener() {
               @Override
