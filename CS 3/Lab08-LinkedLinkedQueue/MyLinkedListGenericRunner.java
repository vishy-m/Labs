public class MyLinkedListGenericRunner
{
   ...
   {
      MyGenericLinkedList<Integer> a = new MyGenericLinkedList<>();
      MyGenericLinkedList<Boolean> b = new MyGenericLinkedList<>(true);
      MyGenericLinkedList<Double>  c = new MyGenericLinkedList<>(3.14159, 1.0, 1.0);
