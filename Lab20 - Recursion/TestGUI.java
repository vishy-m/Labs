/**
 * TestGUI by Kris McCoy & Dagar Ahmed   v2.16  ALTERED  (run as thread allows String for static)
 * Run customized tests of various classes/method and custom build your GUI

 * This version adds:
 * Added runAsThread to allow methods to be run in a separate thread.
...
public class TestGUI 
{
    ...
    public static final double V_NUM = 2.16;
    ...
    static class TestData {
        ...
        public static boolean runAsThread(String cName, String name, Object[] args) {                  
            try {                                
                Class<?> c = getClassFromName(cName);
                if (c == null) return false;
                return runAsThread(c, name, args);           
            } catch (Exception e) {
                return false;              
            }  
        }  
